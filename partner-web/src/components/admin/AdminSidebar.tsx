...
// Admin-web is the FULL control center — all management pages are accessible here.
// customer-web and partner-web share these components via directory junctions,
// so any component change here auto-propagates to both sites.
const NAV_ITEMS = [
